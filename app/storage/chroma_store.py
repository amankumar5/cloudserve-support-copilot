...
def get_vector_store() -> VectorStore:
    ...
    if vtype == "supabase":
        try:
            from app.storage.supabase_store import SupabaseVectorStore
            return SupabaseVectorStore()
        except Exception as e:
            logger.warning(f"Failed initializing SupabaseVectorStore: {e}. Falling back to ChromaVectorStore.")
